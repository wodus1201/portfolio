        ...
        <div className="flex flex-wrap justify-center gap-8">
          {projects.map((project) => (
            <Link
              ...
              className="group bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 w-full max-w-sm"
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-custom-600 transition-colors">{project.title}</h3>
