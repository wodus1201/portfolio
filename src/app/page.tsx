...
const projectsData = [
  {
    ...
    description: "에어팟 모션 데이터를 활용해 머리 움직임만으로 시스템 커서를 제어하고, 웹 대시보드에서 단축키 설정 · 시각화를 지원하는 크로스플랫폼 협업 프로젝트",
      ...
      "웹 대시보드 (React)": [
        {
          ...
          "머리 움직임 기반 3D 가상 헤드 시각화 (기여도: 100%)": ["Three.js로 머리 움직임 실시간 연동 3D 시각화 구현", "Scene/Camera와 모션 데이터 바인딩", "시각적 피드백 제공"],
      ...
      "앱 (Swift)": [
        {
          ...
          "자연스러운 커서 이동 구현 (기여도: 70%)": ["방향 기반 좌표 매핑과 속도 보정 알고리즘 적용", "부드러운 이동을 위해 위치 보간(Linear/Bezier)과 델타 필터링 적용"],
        },
      ],
    },
